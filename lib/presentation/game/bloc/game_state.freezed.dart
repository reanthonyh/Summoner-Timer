...
class _Loaded implements GameState {
  const _Loaded(this.gameInformation);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&(identical(other.gameInformation, gameInformation) || other.gameInformation == gameInformation));
}


@override
int get hashCode => Object.hash(runtimeType,gameInformation);

@override
String toString() {
  return 'GameState.loaded(gameInformation: $gameInformation)';
}
...
/// Create a copy of GameState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? gameInformation = null,}) {
  return _then(_Loaded(
null == gameInformation ? _self.gameInformation : gameInformation // ignore: cast_nullable_to_non_nullable
as GameInformation,
  ));
}
