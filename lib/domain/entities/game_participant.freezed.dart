...
mixin _$GameParticipant {
 ...
 String? get puuid; bool get isBot; SummonerSpell get spellOne; SummonerSpell get spellTwo; String get riotId; int get championId; Team get team;
...
@override
int get hashCode => Object.hash(runtimeType,puuid,isBot,spellOne,spellTwo,riotId,championId,team);

@override
String toString() {
  return 'GameParticipant(puuid: $puuid, isBot: $isBot, spellOne: $spellOne, spellTwo: $spellTwo, riotId: $riotId, championId: $championId, team: $team)';
}
...
@useResult
$Res call({
 String? puuid, bool isBot, SummonerSpell spellOne, SummonerSpell spellTwo, String riotId, int championId, Team team
});
...
/// Create a copy of GameParticipant
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? puuid = freezed,Object? isBot = null,Object? spellOne = null,Object? spellTwo = null,Object? riotId = null,Object? championId = null,Object? team = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? puuid,  bool isBot,  SummonerSpell spellOne,  SummonerSpell spellTwo,  String riotId,  int championId,  Team team)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameParticipant() when $default != null:
return $default(_that.puuid,_that.isBot,_that.spellOne,_that.spellTwo,_that.riotId,_that.championId,_that.team);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? puuid,  bool isBot,  SummonerSpell spellOne,  SummonerSpell spellTwo,  String riotId,  int championId,  Team team)  $default,) {final _that = this;
switch (_that) {
case _GameParticipant():
return $default(_that.puuid,_that.isBot,_that.spellOne,_that.spellTwo,_that.riotId,_that.championId,_that.team);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? puuid,  bool isBot,  SummonerSpell spellOne,  SummonerSpell spellTwo,  String riotId,  int championId,  Team team)?  $default,) {final _that = this;
switch (_that) {
case _GameParticipant() when $default != null:
return $default(_that.puuid,_that.isBot,_that.spellOne,_that.spellTwo,_that.riotId,_that.championId,_that.team);case _:
  return null;
...
class _GameParticipant implements GameParticipant {
  const _GameParticipant({required this.puuid, this.isBot = false, required this.spellOne, required this.spellTwo, required this.riotId, required this.championId, required this.team});
...
/// Create a copy of GameParticipant
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? puuid = freezed,Object? isBot = null,Object? spellOne = null,Object? spellTwo = null,Object? riotId = null,Object? championId = null,Object? team = null,}) {
